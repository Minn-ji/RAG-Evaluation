...
class DataPreprocessor:
    ...
    async def create_generation_bench_data(self, raw_data: List, save_benchmark_name: str):
        ...
        # 추후 변경 필요
        save_path = f'/home/minjichoi/RAG-Evaluation/RAG_Evaluation/test/{save_benchmark_name}.csv'
        bench_df.to_csv(save_path, index=False)
        
        import json
        with open(f"bench_{save_benchmark_name}.json", "w", encoding="utf-8") as f:
